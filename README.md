...
This table lists the configuration variables required to operate Palo Alto Networks Firewall. These variables are specified when configuring a Firewall asset in Splunk SOAR.
